# Onboarding Skill — Complete Specification & Full SKILL.md Body

**Date:** 2026-03-31
**Purpose:** The complete, unabridged specification for the `/onboard` skill — the most critical skill in the OrgAgent system. This document contains the FULL SKILL.md body that will be written to `.claude/skills/onboard/SKILL.md`.

**Criticality:** This skill bootstraps the ENTIRE organisation. Every other component depends on the files it creates. Zero ambiguity is acceptable.
...
Everything below is the COMPLETE markdown body of the onboarding SKILL.md:
